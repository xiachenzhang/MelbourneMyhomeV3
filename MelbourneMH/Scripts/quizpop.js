...
const quizdata = [
    ...
    {
        question: "Melbourne now has the ___ largest population in Australia.",
        options: ["First", "Second", "Third", "Fourth"],
        answer: "Second",
        category: 2
    },
    {
        question: "The number of people in Melbourne from 2009 to 2018 is:",
        options: ["Growing", "declining", "there is growth and decline", "I’m not sure"],
        answer: "Growing",
        category: 3
    },
    {
        question: "How old is Melbourne?",
        options: ["180+ years old", "250+ years old", "280+ years old", "350+ years old"],
        answer: "180+ years old",
        category: 1
    },
    {
        question: "There are more boys than girls in Melbourne in 2018. Is it true?",
        options: ["Yes", "No"],
        answer: "No",
        category: 3
    },
    {
        question: "Back in 1950s, there are color photographs already.",
        options: ["Yes", "No"],
        answer: "No",
        category: 1
    },
    ...
    {
        question: "In 2016, which age group has the largest percentage in population?",
        options: ["Baby", "Parents", "Teenagers", "Elder"],
        answer: "Parents",
        category: 2
    },
    {
        question: "Which area is the most populous in Melbourn now?",
        options: ["Caulfield", "South Yarra", "Brunswick", "Melbourne CBD"],
        answer: "Melbourne CBD",
        category: 3
    },
    {
        question: "Which area is the least populous in Melbourne now?",
        options: ["West Melbourne", "Kew", "Malvern", "Kinglake"],
        answer: "Kinglake",
        category: 1
    },
    {
        question: "In Melbourne, Dandenong is more populous than:",
        options: ["Collingwood", "South Bank", "North Melbourne;", "All of the other three"],
        answer: "All of the other three",
        category: 3
    },
    {
        question: "In Melbourne, Burnside is less populous than:",
        options: ["Melbourne CBD", "Fitzroy", "Malvern", "All of the other three"],
        answer: "All of the other three",
        category: 1
    }
];
