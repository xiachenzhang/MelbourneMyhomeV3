...
const quizdata = [
    
    {
        ...
        options: ["Glass", "Tin cans", "Paper", "Pens and pencils"],
        answer: "Pens and pencils",
        category: 2
    },
    {
        question: "What is the name of a type of fuel used for cars?",
        options: ["Water", "Petrol", "Firewood", "Coal"],
        answer: "Petrol",
        category: 3
    },
    {
        question: "Which of these is a type of green energy?",
        options: ["A petrol pump", "A coal burning fire", "A wind turbine", "An electric cable"],
        answer: "A wind turbine",
        category: 1
    },
    {
        question: "Which of the following will help you to save water?",
        options: ["have shower 3 times a day", "Flush the toilet 3 times", "Have a very deep bath every day","Have a quick 1-minute shower"],
        answer: "Have a quick 1-minute shower",
        category: 3
    },
    {
        question: "Which of these modes of transport is best for the environment?",
        options: ["Bike", "Car", "Bus", "Tractor"],
        answer: "Bike",
        category: 1
    },

    {
        question: "On which day is Earth Day held every year?",
        options: ["June 18", "May 17", "May 8", "July 11"],
        answer: "June 18",
        category: 2
    },
    {
        question: "What is the name of the world’s largest reef system?",
        options: ["Great Barrier Reef", "Grean Ocean Reef", "Coral reef system", "Kangaroo Island Reef"],
        answer: "Great Barrier Reef",
        category: 3
    },
    {
        question: "What percentage of land area should always remain covered by forest?",
        options: ["10%", "5%", "33%", "None of the above"],
        answer: "33%",
        category: 1
    },
    {
        question: "How much percentage of Nitrogen consist in Earth’s Atmosphere?",
        options: ["10%", "15%", "92%", "78%"],
        answer: "78%",
        category: 3
    },
    {
        question: "Ozone layer is being depleted by;",
        options: ["Smog", "Sulphur dioxide", "Carbon monoxide", "Chloroflurocarbon"],
