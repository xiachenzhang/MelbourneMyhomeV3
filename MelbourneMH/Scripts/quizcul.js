...
const quizdata = [
    ...
    {
        question: "Who were the first people to came to Australia?",
        options: ["Indigenous people", "Europeans", "People from China", "Vietnamese People"],
        answer: "Indigenous people",
        category: 2
    },
    {
        question: "When did the Europeans discovered Australia?",
        options: ["1500s", "1950s", "1600s", "1770s"],
        answer: "1600s",
        category: 3
    },
    {
        question: "First Europeans to discover Australia, came from which country?",
        options: ["Germany", "France", "Netherlands", "Great Britain"],
        answer: "Netherlands",
        category: 1
    },
    {
        question: "What is the name of Englishman who explored and mapped the east coast?",
        options: ["Sir John Monash", "Captain James Cook", "William Dampier","Sir Donald Bradman"],
        answer: "Captain James Cook",
        category: 3
    },
    {
        question: "What was discovered in Australia in 1851, and due to which many people arrived to the country?",
        options: ["Silver", "Coal", "Gold", "Diamond"],
        answer: "Gold",
        category: 1
    },

    {
        question: "Which of these was not a colony of Australia?",
        options: ["New South Wales", "Tasmania", "South Australia", "Queenstown", "Victoria", "Queensland","Western Australia"],
        answer: "Queenstown",
        category: 2
    },
    {
        question: "When does Commonwealth of Australia came into existence?",
        options: ["17 May 1901", "26 April 1931", "1 April 1865", "1 January 1901"],
        answer: "1 January 1901",
        category: 3
    },
    {
        question: "Which one is the fastest growing ancestry group in Australia in 2016?",
        options: ["Irish", "Scottish", "British", "Chinese"],
        answer: "Chinese",
        category: 1
    },
    {
        question: "What percentage of people out of total are born overseas in 2016?",
        options: ["26.3%", "20.7%", "34%", "10.5%"],
        answer: "26.3%",
        category: 3
    },
    {
        question: "What is the most spoken language other than English?",
        options: ["Arabic", "Cantonese", "Mandarin", "ItalianMandarin"],
        answer: "All of the other three",
        category: 1
    }
];
